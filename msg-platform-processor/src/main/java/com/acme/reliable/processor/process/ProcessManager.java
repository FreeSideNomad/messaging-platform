...
/**
 * Micronaut-specific Process Manager implementation. Handles infrastructure concerns: transactions,
 * dependency injection, and lifecycle. Domain logic is in BaseProcessManager.
 */
@Singleton
