...
public class ProcessReplyConsumer {
    ...
    /**
     * Listen to reply queue and route to process manager
     * STUB: To be fully implemented when JMS configuration is added
     */
    ...
    public void onReply(String body) {
        try {
            ...
            LOG.debug("Received reply: command={} correlation={} type={}",
                commandId, correlationId, type);
    ...
    private CommandReply parseReply(Map<String, Object> message, String type,
                                     UUID commandId, UUID correlationId) {
        return switch (type) {
