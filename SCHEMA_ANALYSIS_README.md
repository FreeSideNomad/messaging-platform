...
This directory now contains comprehensive documentation analyzing the JDBC entity configuration, Flyway migrations, and schema handling in the messaging platform. Three detailed analysis documents have been created:
...
1. **Current architecture is pragmatic**: Uses best tool for each use case (Micronaut Data for simple, Raw JDBC for complex)
...
**Coverage**: msg-platform-persistence-jdbc, msg-platform-payments-worker, msg-platform-core, docker-compose, Flyway scripts
