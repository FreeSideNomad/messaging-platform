...
class MessagingConfigTest {
    ...
    class IntegrationTests {
        ...
        void testFullCustomConfiguration() {
            ...
            assertThat(config.getQueueNaming().getReplyQueue())
                .isEqualTo("PROD.REPLY.QUEUE");
        ...
        void testMultipleInstances() {
            ...
            assertThat(devConfig.getQueueNaming().buildCommandQueue("Test"))
                .isEqualTo("DEV.CMD.TEST.Q");
