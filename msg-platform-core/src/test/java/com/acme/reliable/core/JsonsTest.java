...
class JsonsTest {
  ...
  class MergeTests {
    ...
    void testMergeEmpty() {
      ...
      assertThat(merged).hasSize(1).containsEntry("a", "1");
    }
  ...
  class ToMapTests {
    ...
    void testToMap() {
      ...
      assertThat(map).containsEntry("field1", "value1").containsEntry("field2", 42);
    }
    ...
    void testToMapNested() {
      ...
      assertThat(map).containsKey("name").containsKey("nested");
    }
