...
/**
 * Utility for deriving type-safe step names from DomainCommand classes.
 * Ensures consistency between command types and process steps.
 */
public final class ProcessSteps {
    ...
    /**
     * Derive step name from command class by removing "Command" suffix.
     * This matches the convention used by AutoCommandHandlerRegistry.
     *
     * Example: BookLimitsCommand.class -> "BookLimits"
     *
    ...
    /**
     * Derive optional step name from command class.
     * Convenience method that wraps stepName() in Optional.of().
     *
     * Example: optionalStepName(BookLimitsCommand.class) -> Optional.of("BookLimits")
     *
     * @param commandClass the command class
     ...
     *
     * Example: is(currentStep, BookLimitsCommand.class)
     *
     ...
     *
     * Example: isOneOf(currentStep, BookLimitsCommand.class, BookFxCommand.class)
     *
     * @param currentStep the current step name
     ...
     */
    @SafeVarargs
    public static boolean isOneOf(String currentStep, Class<? extends DomainCommand>... commandClasses) {
