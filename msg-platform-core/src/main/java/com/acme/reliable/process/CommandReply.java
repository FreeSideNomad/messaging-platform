...
public record CommandReply(
  ...
  public static CommandReply completed(
      UUID commandId, UUID correlationId, Map<String, Object> data) {
    return new CommandReply(
        commandId, correlationId, ReplyStatus.COMPLETED, Map.copyOf(data), null);
  }
