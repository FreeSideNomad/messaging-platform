...
/**
 * Sealed interface representing events in a process lifecycle.
 * All events are immutable and used for event sourcing the process log.
 */
@JsonTypeInfo(
...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = ProcessEvent.CompensationCompleted.class, name = "CompensationCompleted"),
