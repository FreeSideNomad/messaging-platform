...
/**
 * Represents a single step in a process DAG.
 * Can have a direct next step, conditional next steps, parallel branches, or be terminal.
 */
public class ProcessStep {
    ...
    public static class ConditionalNext implements NextStepStrategy {
        ...
        public ConditionalNext(Predicate<Map<String, Object>> condition, String trueStep, String falseStep) {
