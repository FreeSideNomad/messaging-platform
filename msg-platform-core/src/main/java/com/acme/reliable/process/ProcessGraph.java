...
/**
 * Represents a process as a directed acyclic graph (DAG) of steps.
 * This is constructed once during process definition initialization
 * and then navigated during process execution.
 */
