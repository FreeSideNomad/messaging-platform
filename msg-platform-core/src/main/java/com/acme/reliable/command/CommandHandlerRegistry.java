...
/**
 * Registry for command handlers - maps command types to their handlers.
 * This is a generic infrastructure component that can be used by any bounded context.
...
public class CommandHandlerRegistry {
    ...
    public CommandReply handle(CommandMessage command) {
        ...
        try {
            ...
            log.info("Command handled successfully: {} id={}", command.commandType(), command.commandId());
            return reply;
        } catch (Exception e) {
