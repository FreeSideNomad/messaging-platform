...
public record Money(
    ...
    public static Money of(double amount, String currencyCode) {
        return new Money(BigDecimal.valueOf(amount).setScale(2, java.math.RoundingMode.HALF_UP), currencyCode);
    }
    ...
    public Money add(Money other) {
        ...
        return new Money(this.amount.add(other.amount).setScale(2, java.math.RoundingMode.HALF_UP), this.currencyCode);
    }
    ...
    public Money subtract(Money other) {
        ...
        return new Money(this.amount.subtract(other.amount).setScale(2, java.math.RoundingMode.HALF_UP), this.currencyCode);
    }

    public Money multiply(BigDecimal multiplier) {
        return new Money(this.amount.multiply(multiplier).setScale(2, java.math.RoundingMode.HALF_UP), this.currencyCode);
    }
