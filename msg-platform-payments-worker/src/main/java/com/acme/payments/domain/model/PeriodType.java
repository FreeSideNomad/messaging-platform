...
public enum PeriodType {
    ...
    /**
     * Align timestamp to the start of the current time bucket. This ensures all limits for a given
     * period start at natural boundaries.
     */
    public Instant alignToBucketStart(Instant timestamp) {
        return switch (this) {
            ...
            case WEEK -> {
                ...
                LocalDate monday =
                        ldt.toLocalDate().with(TemporalAdjusters.previousOrSame(DayOfWeek.MONDAY));
