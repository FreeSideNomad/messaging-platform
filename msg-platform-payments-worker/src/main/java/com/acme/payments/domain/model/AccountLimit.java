...
public class AccountLimit {
    ...
    public static class LimitExceededException extends RuntimeException {
        ...
        public LimitExceededException(
            ...
            super(String.format("Limit exceeded for %s: limit=%s, utilized=%s, requested=%s, available=%s",
                periodType, limitAmount.amount(), utilized.amount(), requestedAmount.amount(),
