 ...
 * - Opening Credit: Initial balance for new accounts
 * - Funding: Additional credits to top up account (1-20% of balance)
 */
public class TransactionDataGenerator extends BaseDataGenerator {
    ...
    public CreateTransactionCommand generateOpeningCredit(UUID accountId, Money amount) {
        return new CreateTransactionCommand(
            ...
            amount,
            "Opening credit - initial account funding"
        );
    }
     ...
     */
    public CreateTransactionCommand generateFundingTransaction(UUID accountId, String currencyCode, BigDecimal accountBalance) {
