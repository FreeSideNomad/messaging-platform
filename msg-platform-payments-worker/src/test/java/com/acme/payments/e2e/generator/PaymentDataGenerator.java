...
public class PaymentDataGenerator extends BaseDataGenerator {
    ...
    private static final String[] TRANSIT_NUMBERS = {"001", "002", "003", "004", "005", "006", "007", "008", "009", "010"};
    ...
    public InitiateSimplePaymentCommand generateFxPayment(
        ...
        BigDecimal creditAmountValue = debitAmount.amount()
    ...
    public List<InitiateSimplePaymentCommand> generatePayments(
        ...
        for (int i = 0; i < count; i++) {
            if (shouldOccur(fxPercentage)) {
                ...
                payments.add(generateFxPayment(customerId, accountId, currencyCode, creditCurrency, limits));
            } else {
     ...
     */
    protected Money generatePaymentAmount(String currencyCode, Map<PeriodType, Money> limits, boolean enableLimitViolations) {
