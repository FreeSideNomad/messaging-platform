 ...
 * Usage examples:
 * - Generate test data:
 *   java E2ETestRunner generate smoke ./test-data
 *   java E2ETestRunner generate small ./test-data
 *   java E2ETestRunner generate medium ./test-data
 */
@Slf4j
public class E2ETestRunner {
    ...
    private static void handleGenerate(String scenarioName, String[] args) throws IOException {
        ...
        log.info("Configuration: {} accounts, {}-{} payments, {}-{} funding",
        ...
        log.info("   ./src/test/resources/e2e/scripts/load-mq.sh {}/mq/all-messages.jsonl COMMAND.QUEUE 10", outputDir);
    }
