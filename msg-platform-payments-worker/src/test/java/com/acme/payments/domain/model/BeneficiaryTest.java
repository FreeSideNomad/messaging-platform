...
class BeneficiaryTest {
    ...
    class ConstructionTests {
        ...
        void testNullName() {
            assertThatThrownBy(() -> new Beneficiary(
                null,
                "123456789",
                "001",
                "Test Bank"
    ...
    class EdgeCaseTests {
        ...
        void testVariousAccountNumbers() {
            assertThatNoException().isThrownBy(() ->
                new Beneficiary("John", "12345", "001", "Bank"));

            assertThatNoException().isThrownBy(() ->
                new Beneficiary("John", "123456789012345", "001", "Bank"));

            assertThatNoException().isThrownBy(() ->
                new Beneficiary("John", "ABC-123-XYZ", "001", "Bank"));
        }
    }
}
