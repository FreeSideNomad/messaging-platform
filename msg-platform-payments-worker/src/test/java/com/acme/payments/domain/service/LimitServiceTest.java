...
class LimitServiceTest {
    ...
    @Captor
    private ArgumentCaptor<AccountLimit> limitCaptor;
    ...
    void testTimeBucketAlignment() {
        ...
        assertThat(savedLimit.getStartTime())
    ...
    void testLimitAmounts() {
        ...
        AccountLimit hourLimitSaved = savedLimits.stream()
            .filter(l -> l.getPeriodType() == PeriodType.HOUR)
            .findFirst()
            .orElseThrow();

        AccountLimit dayLimitSaved = savedLimits.stream()
