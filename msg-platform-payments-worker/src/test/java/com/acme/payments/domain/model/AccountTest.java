...
class AccountTest {
    ...
    class CreditTransactionTests {
        ...
        void testCreditTransaction() {
            ...
            Transaction transaction =
                    account.createTransaction(
                            TransactionType.CREDIT, Money.of(500, "USD"), "Initial deposit");
        ...
        void testCreditWrongCurrency() {
            ...
            assertThatThrownBy(
                    () ->
                            account.createTransaction(
                                    TransactionType.CREDIT, Money.of(100, "EUR"), "Deposit"))
                    .isInstanceOf(IllegalArgumentException.class)
    ...
    class DebitTransactionTests {
        ...
        void testDebitTransaction() {
            ...
            Transaction transaction =
                    account.createTransaction(TransactionType.DEBIT, Money.of(300, "USD"), "Withdrawal");
        ...
        void testDebitInsufficientFunds() {
            ...
            assertThatThrownBy(
                    () ->
                            account.createTransaction(
                                    TransactionType.DEBIT, Money.of(600, "USD"), "Withdrawal"))
        ...
        void testDebitWrongCurrency() {
            ...
            assertThatThrownBy(
                    () ->
                            account.createTransaction(
                                    TransactionType.DEBIT, Money.of(100, "EUR"), "Withdrawal"))
                    .isInstanceOf(IllegalArgumentException.class)
                    .hasMessageContaining("Transaction currency must match account currency");
        }
    ...
    class MixedTransactionTests {
        ...
        void testBalanceTracking() {
            ...
            Transaction t1 =
                    account.createTransaction(TransactionType.CREDIT, Money.of(1000, "USD"), "Initial");
            assertThat(t1.balance()).isEqualTo(Money.of(1000, "USD"));

            Transaction t2 =
                    account.createTransaction(TransactionType.DEBIT, Money.of(300, "USD"), "Payment");
    ...
    class TransactionListTests {
        ...
        void testTransactionOrder() {
            ...
            Transaction t1 =
                    account.createTransaction(TransactionType.CREDIT, Money.of(100, "USD"), "First");
            Transaction t2 =
                    account.createTransaction(TransactionType.CREDIT, Money.of(200, "USD"), "Second");
            Transaction t3 =
                    account.createTransaction(TransactionType.DEBIT, Money.of(50, "USD"), "Third");

            assertThat(account.getTransactions()).containsExactly(t1, t2, t3);
        }
    ...
    class EdgeCaseTests {
        ...
        void testZeroAmountTransaction() {
            ...
            Transaction transaction =
                    account.createTransaction(TransactionType.CREDIT, Money.zero("USD"), "Zero deposit");
                            ...
                            () -> {
                                Account usdAccount =
                                        new Account(
                                                ...
                                                false,
                                                Money.zero("USD"));
                                usdAccount.createTransaction(
                                        TransactionType.CREDIT, Money.of(100, "USD"), "Deposit");
                            });
                            ...
                            () -> {
                                Account gbpAccount =
                                        new Account(
                                                ...
                                                false,
                                                Money.zero("GBP"));
                                gbpAccount.createTransaction(
                                        TransactionType.CREDIT, Money.of(100, "GBP"), "Deposit");
                            });
        }
    }
}
