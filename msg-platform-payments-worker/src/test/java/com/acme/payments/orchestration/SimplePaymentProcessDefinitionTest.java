...
/**
 * Unit tests for SimplePaymentProcessDefinition.
 * Validates the process graph structure, flow, and compensation logic.
 */
...
class SimplePaymentProcessDefinitionTest {
    ...
    void testHandleInitiateSimplePayment_NoFx() {
        // Given
        InitiateSimplePaymentCommand cmd = new InitiateSimplePaymentCommand(
            UUID.randomUUID(),
            UUID.randomUUID(),
            Money.of(100, "USD"),
    ...
    void testIsRetryable_BusinessError() {
        assertThat(processDefinition.isRetryable("BookLimitsCommand", "Insufficient funds"))
            .isFalse();
    }
    ...
    void testIsRetryable_NullError() {
        assertThat(processDefinition.isRetryable("BookLimitsCommand", null))
            .isFalse();
    }
