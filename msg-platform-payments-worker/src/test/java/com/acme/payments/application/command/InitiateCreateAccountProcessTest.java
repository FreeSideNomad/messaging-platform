...
class InitiateCreateAccountProcessTest {
    ...
    void testCreateCommand_AllParametersValid() {
        ...
        assertThat(cmd.limits().get(PeriodType.DAY)).isEqualTo(Money.of(BigDecimal.valueOf(5000), "USD"));
    }
    ...
    void testCreateCommand_LimitBasedWithoutLimits_ThrowsException() {
        ...
        // When/Then
        assertThatThrownBy(() -> new InitiateCreateAccountProcess(
            customerId,
            "USD",
            "001",
            AccountType.CHECKING,
    ...
    void testCreateCommand_NonLimitBasedWithLimits_ThrowsException() {
        ...
        UUID customerId = UUID.randomUUID();
        Map<PeriodType, Money> limits = Map.of(
            PeriodType.DAY, Money.of(BigDecimal.valueOf(1000), "USD")
        );
    ...
    void testCreateCommand_AllPeriodTypes_Success() {
        ...
        assertThat(cmd.limits()).containsKeys(
            PeriodType.MINUTE,
            PeriodType.HOUR,
            PeriodType.DAY,
            PeriodType.WEEK,
    ...
    void testCreateCommand_ZeroAmountLimits() {
        ...
        UUID customerId = UUID.randomUUID();
        Map<PeriodType, Money> limits = Map.of(
            PeriodType.DAY, Money.of(BigDecimal.ZERO, "USD")
        );
    ...
    void testCreateCommand_LargeLimitAmounts() {
        ...
        Map<PeriodType, Money> limits = Map.of(
            PeriodType.MONTH, Money.of(largeAmount, "USD")
        );
