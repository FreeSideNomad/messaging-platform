...
class JdbcAccountLimitRepositoryIntegrationTest implements TestPropertyProvider {
    ...
    void testSaveAndFind() {
        ...
        List<AccountLimit> retrieved = limitRepository.findByAccountIdAndPeriodType(accountId, PeriodType.DAY);
    ...
    void testFindByAccountIdAndPeriodTypeNotFound() {
        // When
        List<AccountLimit> result = limitRepository.findByAccountIdAndPeriodType(UUID.randomUUID(), PeriodType.DAY);
    ...
    void testFindActiveByAccountId() {
        ...
        AccountLimit hourLimit = new AccountLimit(
            UUID.randomUUID(),
            accountId,
            PeriodType.HOUR,
            now,
        ...
        AccountLimit dayLimit = new AccountLimit(
            UUID.randomUUID(),
            accountId,
            PeriodType.DAY,
    ...
    void testFindActiveByAccountIdExcludesExpired() {
        ...
        // Active limit
        AccountLimit activeLimit = new AccountLimit(
            UUID.randomUUID(),
            accountId,
            PeriodType.DAY,
            now.truncatedTo(ChronoUnit.DAYS),
    ...
    void testAllPeriodTypes() {
        ...
        AccountLimit weekLimit = new AccountLimit(
            UUID.randomUUID(),
            accountId,
            PeriodType.WEEK,
        ...
        AccountLimit monthLimit = new AccountLimit(
            UUID.randomUUID(),
            accountId,
            PeriodType.MONTH,
    ...
    void testVariousCurrencies() {
        ...
        AccountLimit usdLimit = new AccountLimit(
            usdLimitId,
            accountId,
            PeriodType.DAY,
            startTime,
        ...
        AccountLimit eurLimit = new AccountLimit(
            eurLimitId,
            otherAccountId,
            PeriodType.DAY,
            startTime,
        ...
        // Then
        List<AccountLimit> retrievedUsd = limitRepository.findByAccountIdAndPeriodType(accountId, PeriodType.DAY);
        List<AccountLimit> retrievedEur = limitRepository.findByAccountIdAndPeriodType(otherAccountId, PeriodType.DAY);
    ...
    void testBookingAndReversal() {
        ...
        // Then: Verify booking
        List<AccountLimit> afterBooking = limitRepository.findByAccountIdAndPeriodType(accountId, PeriodType.DAY);
        ...
        List<AccountLimit> afterReversal = limitRepository.findByAccountIdAndPeriodType(accountId, PeriodType.DAY);
    ...
    void testLargeAmounts() {
        ...
        // When
        limitRepository.save(limit);
        List<AccountLimit> retrieved = limitRepository.findByAccountIdAndPeriodType(accountId, PeriodType.MONTH);
    ...
    void testMultipleAccounts() {
        ...
        AccountLimit limit1 = new AccountLimit(
            UUID.randomUUID(),
            account1,
            PeriodType.DAY,
            now,
        ...
        AccountLimit limit2 = new AccountLimit(
            UUID.randomUUID(),
            account2,
            PeriodType.DAY,
            now,
