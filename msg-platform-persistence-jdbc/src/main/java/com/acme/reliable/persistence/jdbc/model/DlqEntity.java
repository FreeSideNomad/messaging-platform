...
/**
 * Persistence model for DLQ (Dead Letter Queue) table. Contains Micronaut Data annotations for JDBC
 * mapping.
 */
...
public class DlqEntity {
  ...
  @Nullable @MappedProperty(value = "error_message", type = DataType.STRING)
