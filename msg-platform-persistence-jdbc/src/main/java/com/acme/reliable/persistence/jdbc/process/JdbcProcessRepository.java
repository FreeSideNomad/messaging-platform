...
public class JdbcProcessRepository implements ProcessRepository {
    ...
    public void insert(ProcessInstance instance, ProcessEvent initialEvent) {
        try (Connection conn = dataSource.getConnection()) {
            ...
            LOG.info("Inserted process instance: {} type={} key={}",
    ...
    @Override
    @Transactional(readOnly = true)
    public List<ProcessInstance> findByTypeAndStatus(String processType, ProcessStatus status, int limit) {
        String sql = """
            SELECT process_id, process_type, business_key, status, current_step, data, retries, created_at, updated_at
            FROM process_instance
    ...
    private void insertLogEntry(Connection conn, UUID processId, ProcessEvent event) throws SQLException {
        String sql = """
