...
public class IbmMqFactoryProvider {
  ...
  public jakarta.jms.ConnectionFactory mqConnectionFactory() throws Exception {
    ...
    cf.setBooleanProperty(
        com.ibm.msg.client.jakarta.wmq.WMQConstants.USER_AUTHENTICATION_MQCSP, true);
    cf.setStringProperty(
        com.ibm.msg.client.jakarta.wmq.WMQConstants.USERID,
        System.getenv().getOrDefault("MQ_USER", "app"));
    cf.setStringProperty(
        com.ibm.msg.client.jakarta.wmq.WMQConstants.PASSWORD,
        System.getenv().getOrDefault("MQ_PASS", "passw0rd"));
    ...
    cf.setIntProperty(
        com.ibm.msg.client.jakarta.wmq.WMQConstants.WMQ_CLIENT_RECONNECT_OPTIONS,
    ...
    cf.setIntProperty(
        com.ibm.msg.client.jakarta.wmq.WMQConstants.WMQ_SHARE_CONV_ALLOWED,
